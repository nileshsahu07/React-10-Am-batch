...
function Todo(){
    ...
    function handleForm(e){
        e.preventDefault() 
        if(editIndex !== null){
          const updatedTodo = [...myArray]
          updatedTodo[editIndex].task = todo
          setArray(updatedTodo)
          setEditIndex(null)
        }else if(todo.trim() !== ""){
            setArray(...myArray,todo)
        }
        setTodo("")
    }
            ...
            <div className="container">
                <div>
                    <form onSubmit={handleForm}>
                        ...
                        <button type="submit" className="edit_btn">{editIndex !== null ? 'Update' : 'Add'}</button>
